...
export default function Home() {
  ...
  const projects = [
    ...
    {
      title: "ToDo List App",
      tech: "React.js, LocalStorage, UUID, FontAwesome, CSS",
  ...
  const tasks = [
    {
      id: "task-1",
      title: "Weather App",
      tech: "React.js, CSS3, OpenWeatherMapAPI, JSON Server",
      img: require("../assets/task-1.png"),
      github: "https://github.com/Bharathyadav55/Weather-App",
      demo: "weather-app-bharathyadav.netlify.app",
      readMoreClick: null,
    },
    // {
    //   id: "task-2",
      ...
      <div className="md:ml-[300px] min-h-screen lg:ml-[300px] xl:ml-[400px] transition-all">
        <div>
          <div className="p-6">
            ...
            Frontend Developer with hands-on experience in React.js, JavaScript, and responsive web development. 
            Passionate about creating user-friendly applications and leveraging modern web technologies. 
            Skilled in problem-solving and collaborative team environments, ready to contribute to a dynamic team.
            </p>
