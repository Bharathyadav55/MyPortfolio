        ...
        <div className="flex flex-col items-center gap-1 text-text-info p-5">
          <div className="flex gap-4 justify-start w-[150px] p-2 hover:text-text-primary">
            ...
            <span>
              <a
                ...
                href="https://drive.google.com/file/d/1-J9L2z50dmDR09VnTkJgWwmNw1_IikoS/view?usp=drive_link"
              >
                Resume
              </a>
            </span>
          ...
          <div className="flex gap-4 justify-start w-[150px] p-2 hover:text-text-primary">
            ...
            <span>
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://github.com/Bharathyadav55"
              >
                Github
              </a>
            </span>
          ...
          <div className="flex gap-4 justify-start w-[150px] p-2 hover:text-text-primary">
            ...
            <span>
              <a
                target="_blank"
                rel="noopener noreferrer"
                href="https://www.linkedin.com/in/bharath-yadav-66712324b/"
              >
                Linkedin
              </a>
            </span>
          ...
          <div className="flex gap-4 justify-start w-[150px] p-2 hover:text-text-primary">
            ...
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="mailto:bharathyadav650@gmail.com"
            >
              Email
            </a>
            <br />
